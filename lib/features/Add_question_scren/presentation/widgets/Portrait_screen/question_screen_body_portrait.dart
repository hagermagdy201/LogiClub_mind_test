...
class QuestionScreenBodyPortrait extends StatefulWidget {
  final dynamic categoryName;

  const QuestionScreenBodyPortrait({super.key, required this.categoryName});

  @override
  State<QuestionScreenBodyPortrait> createState() => _QuestionScreenBodyState();
}
