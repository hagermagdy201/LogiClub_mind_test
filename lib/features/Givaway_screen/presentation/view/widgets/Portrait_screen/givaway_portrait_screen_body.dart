...
class GivawayPortraitScreenBody extends StatefulWidget {
  const GivawayPortraitScreenBody({super.key});

  @override
  State<GivawayPortraitScreenBody> createState() =>
      _GivawayPortraitScreenBodyState();
}

class _GivawayPortraitScreenBodyState extends State<GivawayPortraitScreenBody> {
